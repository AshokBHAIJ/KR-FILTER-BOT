...
SHORTLINK_API = environ.get('SHORTLINK_API', 'f633a78dbd69f2b98e010471451fa0244d58b1e6')
...
URL = "https://kannadaflixbot-brv2.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kannadaflixbot-brv2.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://kannadaflixbot-brv2.onrender.com".format(FQDN)
else:
    URL = "https://kannadaflixbot-brv2.onrender.com/".format(FQDN)
