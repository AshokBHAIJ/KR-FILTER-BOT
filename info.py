...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://TPM1:TPM1@cluster0.ejbu5fc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/KannadaFlix6')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KannadaFlix6')
...
if HAS_SSL:
    URL = "https://kannadaflixmovie.onrender.com/".format(FQDN)
else:
    URL = "https://kannadaflixmovie.onrender.com/".format(FQDN)
